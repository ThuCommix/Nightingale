...
namespace ThuCommix.EntityFramework.PostgreSql
{
    public class NpgsqlTable<T> : Table<T> where T : Entity
    {
        ...
        /// <summary>
        /// Initializes a new NpgsqlTable class.
        /// </summary>
        /// <param name="dataProvider">The data provider.</param>
        public NpgsqlTable(IDataProvider dataProvider) : base(dataProvider)
        {
        }
        ...
        public override void Create()
        {
            ...
            fieldDefinitions.Add("Id SERIAL PRIMARY KEY");
            fieldDefinitions.Add("Deleted boolean NOT NULL");
