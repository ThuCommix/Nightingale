...
namespace Nightingale.Metadata
{
    public class EntityMetadataService : IEntityMetadataService
    {
		...
		public bool ValidateXml(Stream stream, List<string> validationIssues)
		{
			...
			using (var schemaStream = myAssembly.GetManifestResourceStream("Nightingale.Entity.xsd"))
			{
		...
		public void GenerateEntity(Stream entityStream, Stream destinationStream)
		{
			...
			var xslReader = XmlReader.Create(Assembly.GetExecutingAssembly().GetManifestResourceStream("Nightingale.Entity.xsl"));
