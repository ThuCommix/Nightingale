...
namespace ThuCommix.EntityFramework.Entities
{
    public abstract class Entity
    {
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="T:ThuCommix.EntityFramework.Entities.Entity"/> is Evicted.
		/// </summary>
		internal bool Evicted { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ThuCommix.EntityFramework.Entities.Entity"/> class.
        /// </summary>
        protected Entity()
		{
