...
namespace ThuCommix.EntityFramework.Metadata
{
    public class EntityMetadataService : IEntityMetadataService
    {
		...
		public bool ValidateXml(Stream stream, List<string> validationIssues)
		{
			...
			using (var schemaStream = myAssembly.GetManifestResourceStream("ThuCommix.EntityFramework.Entity.xsd"))
			{
		...
		public void GenerateEntity(Stream entityStream, Stream destinationStream)
		{
			...
			var xslReader = XmlReader.Create(Assembly.GetExecutingAssembly().GetManifestResourceStream("ThuCommix.EntityFramework.Entity.xsl"));
